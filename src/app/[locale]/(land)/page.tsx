...
import TaskConsumer from "./v-gen/_components/task-consumer";
import TaskProducer from "./v-gen/_components/task-producer";
    ...
    <div className="mx-auto flex w-full max-w-screen-xl flex-col gap-4 p-4 md:gap-8 md:p-8">
      ...
      <section className="relative flex w-full flex-1 flex-col gap-4 overflow-hidden md:flex-row md:gap-8">
        ...
        <div className="relative flex-1">
          <TaskConsumer className="absolute bottom-0 left-0 top-0 w-full" />
        </div>
      </section>
    </div>
  );
